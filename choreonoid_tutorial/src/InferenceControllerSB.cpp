...
class InferenceControllerSB : public SimpleController
{
    Body* ioBody;
    double dt;
    ...
    virtual bool initialize(SimpleControllerIO* io) override
    {
        ...
        fs::path inference_target_path
            = fs::path(std::getenv("HOME"))
              / fs::path("genesis_ws/sandbox/genesis_simple_bipedal_rl/logs/"
                         "simple_bipedal_walking/inference_target");
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(InferenceControllerSB)
